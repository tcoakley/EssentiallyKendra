...
if ($log) {
	$Output = "#######################\n";
	$Output .= "FileName: " . $result["post"]["Filename"] . "\n";
	$Output .= "AutoCrop: " . $result["post"]["AutoCrop"] . "\n";
	$Output .= "MediaID: " . $result["post"]["MediaID"] . "\n";
	$Output .= "TempName: " . $result["files"]["Filedata"]["tmp_name"] . "\n";
	$Output .= "#######################";
...
$info = @getimagesize($result["files"]["Filedata"]["tmp_name"]);
$cMediaImages = new cMediaImages();
$cMediaImages->SetAutoCrop($result["post"]["AutoCrop"]);
$cMediaImages->AddFieldValue("MediaID", $result["post"]["MediaID"]);
$cMediaImages->AddFieldValue("Image", $result["post"]["Filename"], $result["files"]["Filedata"]["tmp_name"]);
$cMediaImages->AddFieldValue("Thumb","", null);
$cMediaImages->InsertRecord();
